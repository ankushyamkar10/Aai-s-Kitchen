  ...
  return (
    <div className="bg-gray-200 relative h-[100vh]">
      ...
      <div className="flex flex-col gap-4 w-[80vw] mx-[10vw] p-6 bg-white absolute top-[20%] md:w-[60vw] md:mx-[20vw] lg:w-[40vw] lg:mx-[30vw]">
        ...
        <section
          className="flex items-center justify-center w-fit my-4 mx-auto p-3 border border-gray-400 cursor-pointer"
          ...
          <form className="flex flex-col" onSubmit={(e) => handleSubmit(e)}>
            <div className="my-2">
              <input
                ...
                className="text-sm w-full p-2 my-2 border border-gray-400 focus:outline-none rounded "
            ...
            <div className="mb-2">
              <input
                ...
                className="text-sm w-full p-2 mb- border border-gray-400 focus:outline-none rounded"
            ...
            <button
              type="submit"
              className="text-md py-2 my-2 bg-yellow-500 text-white rounded"
            >
              Submit
            </button>
          </form>
